...
python preprocess_code/Gen_datalist.py --pklroot_label="/dataset/pkl/MRCPS_p512_s384_label_level0/" --pklroot_unlabelt="/dataset/pkl/MRCPS_p512_s512_unlabel_level0/" --saveroot="/dataset/"
